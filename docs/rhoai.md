...
3) Access the `workbench` named `codegen-i1743765545735-notebook`.
...
5) In the terminal, run `cd codegen-i1743765545735` to navigate to your sample app's directory.
